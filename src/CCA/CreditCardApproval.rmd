...
Del resto de los predictores nos parece que van a estar relacionados con OCCUPATION_TYPE los siguientes : NAME_EDUCATION_TYPE, NAME_HOUSING_TYPE y NAME_INCOME_TYPE. 
...
Probamos con 45%, 55%, 60% y 65%. El mejor balance para las necesidades de negocio es con el 60%, con un buen balance entre precisión y exhaustividad.
